          ...
          <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
            <div className="space-y-4 text-center lg:text-left">
              ...
              <p className="text-muted-foreground md:text-xl">
                Our organization is dedicated to promoting animal welfare and advocating for the humane
            ...
            <div className="flex justify-center lg:justify-end">
              <Image
                ...
                height={550}
                alt="Hero"
                className="aspect-square overflow-hidden rounded-xl object-cover sm:w-full max-w-md"
              />
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="space-y-4 text-center lg:text-left">
              ...
              <p className="text-muted-foreground md:text-xl">
                Our organization is committed to protecting and caring for animals in need. We work tirelessly
                to promote humane treatment, rescue animals from abuse and neglect, and educate the public on
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-6 text-center">
            ...
            <p className="max-w-[900px] mx-auto text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              From rescuing abandoned pets to advocating for stronger animal protection laws, our
              organization is constantly working to improve the lives of animals in our community and beyond.
            </p>
          </div>
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-8 sm:grid-cols-2 lg:grid-cols-3 lg:gap-12">
            <Card>
              <CardContent className="flex flex-col items-center justify-center gap-4 p-6">
                <PawPrintIcon className="h-12 w-12 text-primary" />
                <h3 className="text-xl font-bold">Rescue and Rehome</h3>
                <p className="text-muted-foreground text-center">
                  We work tirelessly to rescue abandoned and abused animals, providing them with a safe
                  haven and finding them loving forever homes.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="flex flex-col items-center justify-center gap-4 p-6">
                ...
                <p className="text-muted-foreground text-center">
                  We advocate for stronger animal protection laws and educate the public on the importance
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center gap-4 p-6">
                ...
                <p className="text-muted-foreground text-center">
                  Join our team of dedicated volunteers or consider making a donation to support our mission
      ...
      <section className="bg-muted py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-6 text-center">
            ...
            <p className="max-w-[900px] mx-auto text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              There are many ways you can get involved and support our mission to protect and care for
              animals in need. Whether you want to volunteer, adopt a pet, or make a donation, we appreciate
              your support.
            </p>
          </div>
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-8 sm:grid-cols-2 lg:grid-cols-3 lg:gap-12">
            <Card>
              <CardContent className="flex flex-col items-center justify-center gap-4 p-6">
                ...
                <p className="text-muted-foreground text-center">
                  Join our team of dedicated volunteers and help us make a difference in the lives of
                  animals.
                </p>
                <Link
                  href="#"
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center gap-4 p-6">
                ...
                <p className="text-muted-foreground text-center">
                  Your financial support helps us continue our important work and make a lasting impact on
